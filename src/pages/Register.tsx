...
const Register = () => {
  ...
  const inputClass = (field: keyof FormData) =>
    `w-full rounded-xl border bg-background px-4 py-3 text-foreground outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20 ${
    ...
    <div>
      <section className="hero-gradient px-4 py-20 text-center text-primary-foreground">
        ...
        <p className="mt-3 text-primary-foreground/70">
          Enroll your child for a brighter future
        </p>
      </section>
          ...
          {submitted ? (
            <div className="py-12 text-center">
              ...
              <button
                ...
                className="mt-6 rounded-full bg-primary px-8 py-3 font-semibold text-primary-foreground transition-all hover:scale-105"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-primary py-3.5 font-heading font-semibold text-primary-foreground transition-all hover:scale-[1.02] hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
              >
